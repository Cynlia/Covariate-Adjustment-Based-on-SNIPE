...
def plot(graph,x_var,x_label,model,x_plot,est_names,permute=False):
    ...
    sns.lineplot(x=x_var, y='Relative_Bias', hue='Estimator', style='Estimator', data=df, ci='sd', legend='brief', markers=True, style_order=est_names, hue_order= est_names, palette=['#ff7f0e', '#2ba02c', '#9468bd', '#d62728'])
    ax.set_ylim(-1,1)
